...
import { processColorsInProps, processStyleValue, processTransform, processTransformOrigin, stylePropsBuilder } from "../common/index.js";
...
const updateProps = (viewDescriptors, updates, isAnimatedProps) => {
  ...
  if (isAnimatedProps) {
    ...
    if ('transformOrigin' in updates) {
      updates.transformOrigin = processStyleValue(processTransformOrigin, updates.transformOrigin);
    }
    if ('transform' in updates) {
      updates.transform = processStyleValue(processTransform, updates.transform);
    }
  }
...
//# sourceMappingURL=updateProps.native.js.map