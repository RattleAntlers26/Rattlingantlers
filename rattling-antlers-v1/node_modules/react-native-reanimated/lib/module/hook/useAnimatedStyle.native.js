...
export function useAnimatedStyle(updater, _dependencies, adapters, isAnimatedProps = false) {
  if (__DEV__ && _dependencies !== undefined && _dependencies !== null) {
    logger.warnOnce('Dependencies should only be used on the web and are always ignored on native. Check DevTools to see the offending code.', isAnimatedProps ? 2 : 1);
  }
