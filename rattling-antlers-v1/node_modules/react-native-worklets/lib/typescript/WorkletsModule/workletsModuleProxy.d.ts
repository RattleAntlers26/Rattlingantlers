...
export interface WorkletsModuleProxy {
    ...
    scheduleOnUI<TValue>(serializableArrayOfWorklets: SerializableRef<TValue[]>, serializableArrayOfArguments: SerializableRef<unknown[]>, scheduleStacks: string[] | undefined): void;
    runOnUISync<TValue, TReturn>(serializable: SerializableRef<TValue>, scheduleStack: string | undefined): TReturn;
    createWorkletRuntime(name: string, initializer: SerializableRef<() => void>, useDefaultQueue: boolean, customQueue: object | undefined, enableEventLoop: boolean, enableLocking: boolean, enableNetworking: boolean): WorkletRuntime;
    ...
    createSynchronizable<TValue>(value: SerializableRef<TValue> | TValue, isFixed: boolean): SynchronizableRef<TValue>;
    ...
    synchronizableSetBlocking<TValue>(synchronizableRef: SynchronizableRef<TValue>, value: SerializableRef<TValue> | TValue): void;
    synchronizableSetDirty<TValue extends number | boolean>(synchronizableRef: SynchronizableRef<TValue>, value: TValue): void;
